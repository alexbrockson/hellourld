                ...
                if (shorturl.length == 0) {
                    ...
                    if (error) {
                        ...
                        if (error2) {
                            ...
                            setLink('Your short URL: ' + window.location.href + "lnk/" + newShortUrl);
                        }
                    }
                }
                else {
                    ...
                    if (error) {
                        ...
                        if (!record[0]){
                            ...
                            if (error) {
                                ...
                                setLink('Your short URL: ' + window.location.href + "lnk/" + shorturl);
                            }
                        }
                        else {
        ...
        <>
            ...
            {link && (
                <div className="bg-green-100 rounded-lg py-5 px-6 mb-3 text-base text-green-700 inline-flex items-center w-full" role="alert">
                    ...
                    <strong className="mr-1">Success! </strong> Here's your link: {link}
                    <button type="button" className="btn-close box-content w-4 h-4 p-1 ml-auto text-green-900 border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-green-900 hover:opacity-75 hover:no-underline" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            )}
        </>
